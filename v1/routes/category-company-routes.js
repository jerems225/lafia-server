...
router.get('/categories-companies', getCategories); //get all category companies
router.get('/category-company/:category_uuid',  getCategory); //get category company
router.get('/category-company-status/:category_uuid',  getCategoryByStatus); //get category company by status
