...
const { getOrdersByCompany, getOrdersByRider, getOrder, getOrdersByStatus } = require('../controllers/orders/getOrder');
...
router.get('/orders', requireAuth, getOrdersByStatus) //get orders by status
